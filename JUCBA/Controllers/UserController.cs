...
using JUCBA.Core.ViewModels.UserViewModels;
using System;
        ...
        public async Task<ActionResult> Create(CreateUserViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var user = new ApplicationUser { UserName = model.Username, Email = model.Email, BranchID = model.BranchID, RoleID = model.RoleID, FullName = model.FullName, PhoneNumber = model.PhoneNumber, PasswordChanged = false};
