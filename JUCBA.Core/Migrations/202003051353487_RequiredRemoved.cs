namespace JUCBA.Core.Migrations
{
    ...
    public partial class RequiredRemoved : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.AccountConfigurations", "CurrentInterestExpenseGlID");
            CreateIndex("dbo.AccountConfigurations", "SavingsInterestPayableGlID");
            AddForeignKey("dbo.AccountConfigurations", "SavingsInterestPayableGlID", "dbo.GlAccounts", "ID", cascadeDelete: true);
            AddForeignKey("dbo.AccountConfigurations", "LoanInterestReceivableGlID", "dbo.GlAccounts", "ID", cascadeDelete: true);
            AddForeignKey("dbo.AccountConfigurations", "LoanInterestIncomeGlID", "dbo.GlAccounts", "ID", cascadeDelete: true);
            AddForeignKey("dbo.AccountConfigurations", "LoanInterestExpenseGLID", "dbo.GlAccounts", "ID", cascadeDelete: true);
            AddForeignKey("dbo.AccountConfigurations", "CurrentInterestPayableGlID", "dbo.GlAccounts", "ID", cascadeDelete: true);
            AddForeignKey("dbo.AccountConfigurations", "CurrentInterestExpenseGlID", "dbo.GlAccounts", "ID", cascadeDelete: true);
