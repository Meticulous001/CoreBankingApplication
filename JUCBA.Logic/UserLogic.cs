...
namespace JUCBA.Logic
{
    public class UserLogic
    {
        ...
        public void SendPasswordToUser(string fullName, string toMail, string username, string password)
        {
            ...
            string msgBody = string.Format(bodyFormat, "MuizCBA", fromEmail, "Hi " + fullName + ", an account has been created for you in CBA. Your username is \"" + username + "\" and your password is: \"" + password + "\". Please keep safely these details as they will be required to access the application");
        ...
        public void SendEmailConfirmationTokenToUser(string callbackUrl, string toMail)
        {
            ...
            string msgBody = string.Format(bodyFormat, "Appzone MuizCBA Project", fromEmail, "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
        ...
        public void SendPasswordResetTokenToUser(string callbackUrl, string toMail)
        {
            string fromEmail = ConfigurationManager.AppSettings["mailAccount"];
            var bodyFormat = "<p>Email From: {0} ({1})</p><p>Message:</p><p>{2}</p>";
            string msgBody = string.Format(bodyFormat, "MuizCBA", fromEmail, "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>");
